...
export class TypeParameterDeclaration extends Node<
    ...
    visit(visitor: Visitor, context: any) {
        if (visitor.visitTypeParameterDeclaration) {
            ...
            throw new Error(
                `${visitor.name} 没有 visitTypeParameterDeclaration 方法`
            );
        }
    }
}
...
export class ShorthandPropertyAssignment extends Node<
    ...
    visit(visitor: Visitor, context: any) {
        if (visitor.visitShorthandPropertyAssignment) {
            ...
            throw new Error(
                `${visitor.name} 没有 visitShorthandPropertyAssignment 方法`
            );
        }
    }
}
...
export class AccessorDeclaration extends Node<ts.AccessorDeclaration>{
    visit(visitor: Visitor, context: any) {
...
export class PropertyAccessExpression extends Node<
    ...
    visit(visitor: Visitor, context: any) {
        if (visitor.visitPropertyAccessExpression) {
            ...
            throw new Error(
                `${visitor.name} 没有 visitPropertyAccessExpression 方法`
            );
        }
    }
}
...
export class NullLiteral extends Node<ts.NullLiteral> {
    visit(visitor: Visitor, context: any) {
...
export class NoSubstitutionTemplateLiteral extends Node<
    ...
    visit(visitor: Visitor, context: any) {
        if (visitor.visitNoSubstitutionTemplateLiteral) {
            ...
            throw new Error(
                `${visitor.name} 没有 visitNoSubstitutionTemplateLiteral 方法`
            );
        }
    }
}
...
export type LeftHandSideExpression = PropertyAccessExpression
...
export class ExpressionWithTypeArguments extends Node<
    ...
    visit(visitor: Visitor, context: any) {
        if (visitor.visitExpressionWithTypeArguments) {
            ...
            throw new Error(
                `${visitor.name} 没有 visitExpressionWithTypeArguments 方法`
            );
        }
    }
}
...
export class RegularExpressionLiteral extends Node<
    ...
    visit(visitor: Visitor, context: any) {
        if (visitor.visitRegularExpressionLiteral) {
            ...
            throw new Error(
                `${visitor.name} 没有 visitRegularExpressionLiteral 方法`
            );
        }
    }
}
export class TaggedTemplateExpression extends Node<
    ...
    visit(visitor: Visitor, context: any) {
        if (visitor.visitTaggedTemplateExpression) {
            ...
            throw new Error(
                `${visitor.name} 没有 visitTaggedTemplateExpression 方法`
            );
        }
    }
}
...
export class ConstructSignatureDeclaration extends Node<
    ...
    visit(visitor: Visitor, context: any) {
        if (visitor.visitConstructSignatureDeclaration) {
            ...
            throw new Error(
                `${visitor.name} 没有 visitConstructSignatureDeclaration 方法`
            );
        }
    }
}
...
export class CallSignatureDeclaration extends Node<
    ...
    visit(visitor: Visitor, context: any) {
        if (visitor.visitCallSignatureDeclaration) {
            ...
            throw new Error(
                `${visitor.name} 没有 visitCallSignatureDeclaration 方法`
            );
        }
    }
}
export class IndexSignatureDeclaration extends Node<
    ...
    visit(visitor: Visitor, context: any) {
        if (visitor.visitIndexSignatureDeclaration) {
            ...
            throw new Error(
                `${visitor.name} 没有 visitIndexSignatureDeclaration 方法`
            );
        }
    }
}
...
export interface Visitor<C = any, O = any> {
    ...
    visitConstructSignatureDeclaration?(
...
export class TsVisitor implements Visitor {
    ...
    visitBigIntLiteral(node: BigIntLiteral, context: ts.BigIntLiteral) {
    ...
    visitLiteralExpression(node: any, context: ts.LiteralExpression): any {
        if (util.isBigIntLiteral(context)) {
            ...
            return this.visitNoSubstitutionTemplateLiteral(
                new NoSubstitutionTemplateLiteral(),
                context
            );
        } else if (util.isRegularExpressionLiteral(context)) {
            return this.visitRegularExpressionLiteral(
                new RegularExpressionLiteral(),
                context
            );
        } else {
            return this.visitNullLiteral(new NullLiteral(), context as any);
        }
    }
    ...
    visitEqualsGreaterThanToken(
        ...
        context: ts.EqualsGreaterThanToken
    ) {
        return node;
    }
    ...
    visitExportSpecifier(node: ExportSpecifier, context: ts.ExportSpecifier) {
        if (context.propertyName) {
            node.propertyName = this.visitIdentifier(
                new Identifier(),
    ...
    visitNamedExports(node: NamedExports, context: ts.NamedExports) {
        node.node = context;
        node.elements = context.elements.map(ele =>
            this.visitExportSpecifier(new ExportSpecifier(), ele)
        );
        return node;
    }
    ...
    visitCaseBlock(node: CaseBlock, context: ts.CaseBlock) {
        node.node = context;
        node.clauses = context.clauses.map(cla =>
            this.visitCaseOrDefaultClause(new CaseOrDefaultClause(), cla)
        );
        return node;
    }
    visitCaseOrDefaultClause(
        node: CaseOrDefaultClause,
        context: ts.CaseOrDefaultClause
    ...
    visitCaseClause(node: CaseClause, context: ts.CaseClause): CaseClause {
        node.node = context;
        node.expression = this.visitExpression(
            new Expression(),
            context.expression
        );
        node.statements = context.statements.map(stat =>
            this.visitStatement(undefined, stat)
        );
        return node;
    }
    visitDefaultClause(
        node: DefaultClause,
        context: ts.DefaultClause
    ): DefaultClause {
        node.node = context;
        node.statements = context.statements.map(stat =>
            this.visitStatement(undefined, stat)
    ...
    visitForInitializer(
        node: ForInitializer,
        context: ts.ForInitializer
    ): Expression | VariableDeclarationList {
        node.node = context;
    ...
    visitAwaitKeywordToken(
        node: AwaitKeywordToken,
        context: ts.AwaitKeywordToken
    ): AwaitKeywordToken {
        node.node = context;
        return node;
    }
    ...
    visitStatement(
        ...
        if (ts.isClassDeclaration(context)) {
            ...
            return this.visitTypeAliasDeclaration(
            ...
            return this.visitImportEqualsDeclaration(
                new ImportEqualsDeclaration(),
                context
            );
        } else {
    ...
    visitImportEqualsDeclaration(
        ...
        context: ts.ImportEqualsDeclaration
    ) {
        node.moduleReference = this.visitModuleReference(
            new ModuleReference(),
            context.moduleReference
        );
        if (context.name) {
            node.name = this.visitIdentifier(new Identifier(), context.name);
        }
    ...
    visitExportDeclaration(
        ...
        context: ts.ExportDeclaration
    ) {
        node.node = context;
        if (context.exportClause) {
            node.exportClause = this.visitNamedExports(
                new NamedExports(),
                context.exportClause
            );
        }
        if (context.modifiers) {
            node.modifiers = context.modifiers.map(mod =>
                this.visitModifier(new Modifier(), mod)
            );
        }
        if ((context as any).jsDoc) {
            node.docs = (context as any).jsDoc.map((doc: any) =>
                this.visitJSDoc(new JSDoc(), doc)
            );
        }
        if (context.name) {
            if (ts.isIdentifier(context.name)) {
                ...
                node.name = this.visitNumericLiteral(
                    new NumericLiteral(),
                    context.name
                );
            }
        ...
        if (context.moduleSpecifier) {
            node.moduleSpecifier = this.visitExpression(
                new Expression(),
    ...
    visitExpressionStatement(
        ...
        context: ts.ExpressionStatement
    ) {
        node.node = context;
        node.expression = this.visitExpression(
            new Expression(),
    ...
    visitForInStatement(node: ForInStatement, context: ts.ForInStatement) {
        node.node = context;
        node.initializer = this.visitForInitializer(
            new ForInitializer(),
            context.initializer
        );
        node.expression = this.visitExpression(
    ...
    visitForOfStatement(node: ForOfStatement, context: ts.ForOfStatement) {
        ...
        if (context.awaitModifier) {
            node.awaitModifier = this.visitAwaitKeywordToken(
                new AwaitKeywordToken(),
                context.awaitModifier
            );
        }
        node.initializer = this.visitForInitializer(
            new ForInitializer(),
    ...
    visitIfStatement(node: IfStatement, context: ts.IfStatement) {
        ...
        if (context.elseStatement) {
            node.elseStatement = this.visitStatement(
                undefined,
    ...
    visitTypeAliasDeclaration(
        ...
        context: ts.TypeAliasDeclaration
    ) {
        node.node = context;
        ...
        if (context.typeParameters) {
            node.typeParameters = context.typeParameters.map(type =>
                this.visitTypeParameterDeclaration(new TypeParameterDeclaration(), type)
            );
        }
        return node;
    }
    ...
    visitEnumDeclaration(node: EnumDeclaration, context: ts.EnumDeclaration) {
        ...
        node.members = context.members.map(member =>
            this.visitEnumMember(new EnumMember(), member)
        );
        node.name = this.visitIdentifier(new Identifier(), context.name);
        node.docs = this.createJsDocs((context as any).jsDoc);
        if (context.modifiers) {
    ...
    visitJSDoc(node: JSDoc, context: ts.JSDoc) {
        ...
        if (ts.isJSDoc(context)) {
            ...
            if (context.tags) {
                node.tags = context.tags.map(tag =>
                    this.visitJSDocTag(new JSDocTag(), tag)
                );
            }
        } else {
    ...
    visitEnumMember(node: EnumMember, context: ts.EnumMember) {
        ...
        if (context.initializer) {
            node.initializer = this.visitExpression(
                new Expression(),
                context.initializer
            );
        }
    ...
    visitInterfaceDeclaration(
        ...
        node.docs = this.createJsDocs((context as any).jsDoc);
        node.members = context.members.map(member =>
            this.visitTypeElement(undefined, member)
        );
        node.name = this.visitIdentifier(new Identifier(), context.name);
        node.modifiers = this.createModifiers(node, context.modifiers);
        if (context.typeParameters) {
        ...
        if (context.heritageClauses) {
            node.heritageClauses = context.heritageClauses.map(heri =>
                this.visitHeritageClause(new HeritageClause(), heri)
            );
        }
        return node;
    }
    visitHeritageClause(node: HeritageClause, context: ts.HeritageClause) {
        ...
        node.types = context.types.map(type =>
            this.visitExpressionWithTypeArguments(
    ...
    visitExpressionWithTypeArguments(
        node: ExpressionWithTypeArguments,
        context: ts.ExpressionWithTypeArguments
    ) {
        node.node = context;
        node.expression = this.visitLeftHandSideExpression(
            undefined,
            context.expression
        );
        if (context.typeArguments) {
            node.typeArguments = context.typeArguments.map(type =>
    ...
    visitTypeElement(
        ...
        if (ts.isPropertySignature(context)) {
            ...
            return this.visitIndexSignatureDeclaration(
                new IndexSignatureDeclaration(),
                context
            );
        } else if (util.isConstructSignatureDeclaration(context)) {
            return this.visitConstructSignatureDeclaration(
                new ConstructSignatureDeclaration(),
                context
            );
        } else if (ts.isCallSignatureDeclaration(context)) {
            return this.visitCallSignatureDeclaration(
                new CallSignatureDeclaration(),
                context
            );
        } else {
    ...
    visitIndexSignatureDeclaration(
        node: IndexSignatureDeclaration,
        context: ts.IndexSignatureDeclaration
    ) {
        if (context.name) {
            node.name = this.visitPropertyName(undefined, context.name);
        }
        if (context.questionToken) {
            node.questionToken = this.visitQuestionToken(
                new QuestionToken(),
        ...
        if (context.typeParameters) {
            node.typeParameters = context.typeParameters.map(t =>
                this.visitTypeParameterDeclaration(new TypeParameterDeclaration(), t)
            );
        }
        if (context.parameters) {
            node.parameters = context.parameters.map((p, index) => {
                const res = this.visitParameterDeclaration(
    ...
    visitFunctionDeclaration(
        ...
        context: ts.FunctionDeclaration
    ) {
        node.node = context;
        node.docs = this.createJsDocs((context as any).jsDoc);
        if (context.body) {
        ...
        if (context.typeParameters) {
            node.typeParameters = context.typeParameters.map(par =>
                this.visitTypeParameterDeclaration(new TypeParameterDeclaration(), par)
            );
        }
        if (context.type) {
            node.type = this.visitTypeNode(undefined, context.type);
    ...
    visitVariableStatement(
        ...
        context: ts.VariableStatement
    ) {
        node.node = context;
        node.docs = this.createJsDocs((context as any).jsDoc);
        node.declarationList = this.visitVariableDeclarationList(
            new VariableDeclarationList(),
    ...
    visitVariableDeclarationList(
        ...
        context: ts.VariableDeclarationList
    ) {
        node.node = context;
        node.declarations = context.declarations.map(dec =>
            this.visitVariableDeclaration(new VariableDeclaration(), dec)
        );
        return node;
    }
    visitVariableDeclaration(
        node: VariableDeclaration,
        context: ts.VariableDeclaration
    ) {
        node.node = context;
        node.name = this.visitBindingName(undefined, context.name);
        if (context.exclamationToken) {
            node.exclamationToken = this.visitExclamationToken(
                new ExclamationToken(),
                context.exclamationToken
            );
        }
        if (context.type) {
            node.type = this.visitTypeNode(undefined, context.type);
    ...
    visitImportDeclaration(
        ...
        if (context.importClause) {
            node.importClause = this.visitImportClause(
                new ImportClause(),
    ...
    visitImportClause(node: ImportClause, context: ts.ImportClause) {
        ...
        if (context.namedBindings) {
            node.namedBindings = this.visitNamedImportBindings(
                undefined,
                context.namedBindings
            );
        }
        return node;
    }
    visitNamedImportBindings(
        node: any,
        context: ts.NamedImportBindings
    ...
    visitNamedImports(node: NamedImports, context: ts.NamedImports) {
        node.node = context;
        node.elements = context.elements.map(ele =>
            this.visitImportSpecifier(new ImportSpecifier(), ele)
        );
        return node;
    }
    ...
    visitClassDeclaration(node: ClassDeclaration, context: ts.ClassDeclaration) {
        ...
        if (context.typeParameters) {
            node.typeParameters = context.typeParameters.map(type => {
                const ast = this.visitTypeParameterDeclaration(
    ...
    visitTypeParameterDeclaration(
        ...
        context: ts.TypeParameterDeclaration
    ) {
        node.node = context;
        node.name = this.visitIdentifier(new Identifier(), context.name);
    ...
    visitClassElement(
        ...
        if (ts.isPropertyDeclaration(context)) {
            ...
            return this.visitSemicolonClassElement(
                new SemicolonClassElement(),
                context
            );
        } else if (ts.isConstructorDeclaration(context)) {
            return this.visitConstructorDeclaration(
                new ConstructorDeclaration(),
                context
            );
        } else if (ts.isGetAccessorDeclaration(context)) {
            return this.visitGetAccessorDeclaration(
                new GetAccessorDeclaration(),
                context
            );
        } else if (ts.isSetAccessorDeclaration(context)) {
            return this.visitSetAccessorDeclaration(
                new SetAccessorDeclaration(),
                context
            );
    ...
    visitConstructorDeclaration(
        ...
        context: ts.ConstructorDeclaration
    ) {
        if (context.name) {
            node.name = this.visitPropertyName(undefined, context.name);
        }
        ...
        if (context.decorators) {
            node.decorators = context.decorators.map(dec =>
                this.visitDecorator(new Decorator(), dec)
            );
        }
        if (context.typeParameters) {
            node.typeParameters = context.typeParameters.map(t =>
     ...
     * @param context
     */
    visitSemicolonClassElement(
        node: SemicolonClassElement,
        context: ts.SemicolonClassElement
    ) {
        node.node = context;
        return node;
    }
    ...
    visitParameterDeclaration(
        ...
        context: ts.ParameterDeclaration
    ) {
        node.node = context;
        node.decorators = this.createDecorators(context, node);
        node.docs = this.createJsDocs((context as any).jsDoc);
        if (context.dotDotDotToken) {
            node.dotDotDotToken = this.visitDotDotDotToken(
                new DotDotDotToken(),
    ...
    visitBindingName(node: any, context: ts.BindingName): BindingName {
        if (ts.isObjectBindingPattern(context)) {
            return this.visitObjectBindingPattern(
    ...
    visitArrayBindingPattern(
        ...
        context: ts.ArrayBindingPattern
    ) {
        node.node = context;
        return node;
    }
    visitObjectBindingPattern(
        ...
        context: ts.ObjectBindingPattern
    ) {
        node.node = context;
        return node;
    }
    ...
    visitFunctionBody(node: FunctionBody, context: ts.FunctionBody) {
        node.node = context;
        node.statements = context.statements.map(state =>
            this.visitStatement(undefined, state)
        );
        return node;
    }
    /**
    ...
    visitPropertyDeclaration(
        ...
        context: ts.PropertyDeclaration
    ) {
        node.node = context;
        node.decorators = this.createDecorators(context, node);
        node.docs = this.createJsDocs((context as any).jsDoc);
    ...
    visitExpression(node: Expression, context: ts.Expression): any {
        ...
        if (ts.isStringLiteral(context)) {
            ...
            return this.visitPrefixUnaryExpression(
    ...
    visitNoSubstitutionTemplateLiteral(
        node: NoSubstitutionTemplateLiteral,
        context: ts.NoSubstitutionTemplateLiteral
    ) {
        node.text = context.text;
        node.hasExtendedUnicodeEscape = !!context.hasExtendedUnicodeEscape;
        node.isUnterminated = !!context.isUnterminated;
    ...
    visitElementAccessExpression(
        ...
        context: ts.ElementAccessExpression
    ) {
        return node;
    }
    ...
    visitAwaitExpression(node: AwaitExpression, context: ts.AwaitExpression) {
        node.node = context;
        node.expression = this.visitUnaryExpression(
            new UnaryExpression(),
            context.expression
        );
        return node;
    ...
    visitArrayLiteralExpression(
        ...
        context: ts.ArrayLiteralExpression
    ) {
        node.node = context;
        node.elements = context.elements.map(ele =>
            this.visitExpression(new Expression(), ele)
        );
        return node;
    }
    ...
    visitTypeNode(node: any, context: ts.TypeNode): TypeNode {
        if (ts.isTypeReferenceNode(context)) {
            ...
            return this.visitIndexedAccessTypeNode(
            ...
            return this.visitParenthesizedTypeNode(
                new ParenthesizedTypeNode(),
                context
            );
        } else if (ts.isIntersectionTypeNode(context)) {
            return this.visitIntersectionTypeNode(
                new IntersectionTypeNode(),
                context
            );
        } else if (ts.isExpressionWithTypeArguments(context)) {
            return this.visitExpressionWithTypeArguments(
                new ExpressionWithTypeArguments(),
                context
            );
    ...
    visitJSDocNullableType(node: JSDocNullableType, context: any) {
        return node;
    }
    ...
    visitImportTypeNode(node: ImportTypeNode, context: ts.ImportTypeNode) {
        if (context.typeArguments) {
            node.typeArguments = context.typeArguments.map(t =>
                this.visitTypeNode(undefined, t)
            );
        }
    ...
    visitTypePredicateNode(
        node: TypePredicateNode,
        context: ts.TypePredicateNode
    ) {
        if (ts.isIdentifier(context.parameterName)) {
            node.parameterName = this.visitIdentifier(
                new Identifier(),
                context.parameterName
            );
        } else {
            node.parameterName = this.visitThisTypeNode(
                new ThisTypeNode(),
                context.parameterName
            );
        }
    ...
    visitLiteralTypeNode(node: LiteralTypeNode, context: ts.LiteralTypeNode) {
        if (util.isBooleanLiteral(context.literal)) {
            node.literal = this.visitBooleanLiteral(
                new BooleanLiteral(),
                context.literal
            );
            ...
            node.literal = this.visitPrefixUnaryExpression(
                new PrefixUnaryExpression(),
                context.literal
            );
        }
    ...
    visitTypeLiteralNode(node: TypeLiteralNode, context: ts.TypeLiteralNode) {
        node.members = context.members.map(member =>
            this.visitTypeElement(undefined, member)
        );
        return node;
    }
    visitTypeOperatorNode(node: TypeOperatorNode, context: ts.TypeOperatorNode) {
        node.type = this.visitTypeNode(undefined, context.type);
    ...
    visitIndexedAccessTypeNode(
        ...
        context: ts.IndexedAccessTypeNode
    ) {
    ...
    visitMappedTypeNode(node: MappedTypeNode, context: ts.MappedTypeNode) {
        ...
        if (context.questionToken) {
            if (util.isQuestionToken(context.questionToken)) {
                ...
                node.questionToken = this.visitPlusToken(
                    new PlusToken(),
                    context.questionToken
                );
            } else if (util.isMinusToken(context.questionToken)) {
                node.questionToken = this.visitMinusToken(
                    new MinusToken(),
                    context.questionToken
                );
            }
        ...
        if (context.readonlyToken) {
            if (util.isReadonlyToken(context.readonlyToken)) {
                node.readonlyToken = this.visitReadonlyToken(
                    new ReadonlyToken(),
                    context.readonlyToken
                );
            } else if (util.isPlusToken(context.readonlyToken)) {
                node.readonlyToken = this.visitPlusToken(
                    new PlusToken(),
                    context.readonlyToken
                );
            } else if (util.isMinusToken(context.readonlyToken)) {
                node.readonlyToken = this.visitMinusToken(
                    new MinusToken(),
                    context.readonlyToken
                );
            }
        ...
        if (context.typeParameter) {
            node.typeParameter = this.visitTypeParameterDeclaration(
                new TypeParameterDeclaration(),
    ...
    visitTupleTypeNode(node: TupleTypeNode, context: ts.TupleTypeNode) {
        node.node = context;
        node.elementTypes = context.elementTypes.map(ele =>
            this.visitTypeNode(undefined, ele)
        );
        return node;
    }
    visitTypeReferenceNode(
        node: TypeReferenceNode,
        context: ts.TypeReferenceNode
    ) {
        node.node = context;
        if (context.typeArguments) {
            node.typeArguments = context.typeArguments.map(type =>
    ...
    visitFunctionTypeNode(node: FunctionTypeNode, context: ts.FunctionTypeNode) {
        node.node = context;
        node.docs = this.createJsDocs((context as any).jsDoc);
        node.parameters = context.parameters.map(par =>
            this.visitParameterDeclaration(new ParameterDeclaration(), par)
        );
        node.type = this.visitTypeNode(undefined, context.type);
        if (context.typeParameters) {
            node.typeParameters = context.typeParameters.map(type =>
    ...
    visitPropertyName(node: any, context: ts.PropertyName): PropertyName {
        if (ts.isIdentifier(context)) {
            ...
            return this.visitComputedPropertyName(
                new ComputedPropertyName(),
                context
            );
        }
    }
    visitComputedPropertyName(
        ...
        context: ts.ComputedPropertyName
    ) {
        node.node = context;
        return node;
    }
    ...
    visitLeftHandSideExpression(
        node: any,
        context: ts.LeftHandSideExpression
    ):
    ...
    visitNonNullExpression(node: NonNullExpression, context: ts.NonNullExpression) {
        node.expression = this.visitExpression(new Expression(), context.expression)
        return node;
    }
    visitSuperExpression(node: SuperExpression, context: ts.SuperExpression) {
        return node;
    }
    ...
    visitPropertyAccessExpression(
        ...
        context: ts.PropertyAccessExpression
    ) {
        node.node = context;
        if (context.expression) {
            node.expression = this.visitLeftHandSideExpression(
    ...
    visitCallExpression(node: CallExpression, context: ts.CallExpression) {
        ...
        node.arguments = context.arguments.map(arg =>
            this.visitExpression(new Expression(), arg)
        );
        if (context.typeArguments) {
            node.typeArguments = context.typeArguments.map(arg =>
                this.visitTypeNode(undefined, arg)
            );
        }
        return node;
    }
    visitObjectLiteralExpression(
        ...
        node.node = context;
        node.properties = context.properties.map(pro =>
            this.visitObjectLiteralElementLike(undefined, pro)
        );
        return node;
    }
    visitObjectLiteralElementLike(
        node: any,
        context: ts.ObjectLiteralElementLike
    ) {
        ...
        if (ts.isShorthandPropertyAssignment(context)) {
            return this.visitShorthandPropertyAssignment(
                new ShorthandPropertyAssignment(),
                context
            );
        }
    ...
    visitShorthandPropertyAssignment(
        node: ShorthandPropertyAssignment,
        context: ts.ShorthandPropertyAssignment
    ) {
        node.node = context;
        node.docs = this.createJsDocs((context as any).jsDoc);
        ...
        if (context.questionToken) node.equalsToken = context.equalsToken;
        if (context.objectAssignmentInitializer) node.objectAssignmentInitializer = this.visitExpression(new Expression(), context.objectAssignmentInitializer);
        return node;
    }
    ...
    visitSetAccessorDeclaration(
        ...
        context: ts.SetAccessorDeclaration
    ) {
        node.node = context;
        node.docs = this.createJsDocs((context as any).jsDoc);
        if (context.decorators) {
        ...
        if (context.asteriskToken) {
            node.asteriskToken = this.visitAsteriskToken(
                new AsteriskToken(),
                context.asteriskToken
            );
        }
        if (context.questionToken) {
            node.questionToken = this.visitQuestionToken(
    ...
    visitGetAccessorDeclaration(
        ...
        context: ts.GetAccessorDeclaration
    ) {
        node.node = context;
        node.docs = this.createJsDocs((context as any).jsDoc);
        if (context.decorators) {
